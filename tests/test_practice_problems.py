...
class TestProblems(unittest.TestCase):
    def test_rotated_sorted_list(self):
        ...
        test_cases = [{'sequence':[9, 11,14, 17,1,4,5,7],'output':4},{'sequence':[21,8,12,15],'output':1}ఢడ, {'sequence':[3,6,8,9,11,13],'output':0},{'sequence':[45,65,3,23,32,36],'output':2}ఢఢఢఢఢఢడుిుిుిుిుిుఢ]
          ఢఢేేేేఢఢఢ
